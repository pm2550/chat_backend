...
public interface AgentTaskRepository extends JpaRepository<AgentTask, Long> {
    ...
    @EntityGraph(type = EntityGraph.EntityGraphType.LOAD, attributePaths = {"chatRoom", "requestedBy", "botConfig", "resultMessage", "resultMessage.sender", "resultMessage.botConfig", "resultMessage.anonymousIdentity", "resultMessage.replyToMessage", "resultMessage.replyToMessage.sender", "resultMessage.replyToMessage.anonymousIdentity", "resultMessage.replyToMessage.botConfig"})
